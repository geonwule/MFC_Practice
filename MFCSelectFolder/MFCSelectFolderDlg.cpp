...
// CMFCSelectFolderDlg 메시지 처리기

BOOL CMFCSelectFolderDlg::OnInitDialog()
{
...
void CMFCSelectFolderDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFCSelectFolderDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMFCSelectFolderDlg::OnQueryDragIcon()
{
